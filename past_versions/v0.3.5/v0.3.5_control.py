...
class UmaGame:
    ...
    def _check_training(self, mood_score: float):
        ...
        try:
            ...
            for i in order:
                ...
                print(f"The score under {i + 1}th training option is {score[i]*100//100}")
    ...
    def __update_friendship__(self, supportcard: SupportCard, rg, confi = 0.98):
        ...
        if supportcard.friendship:
            ...
            rg1 = (rg[0]-40, rg[1]+10, 90, 50)
            try:
                pyautogui.locateOnScreen("figures/generaltraining/friendship_orange.png", region=rg1, confidence=confi)
                supportcard.friendship = 1
                print(f"Orange bar identified for {supportcard}")
            except ImageNotFoundException:
                try:
                    pyautogui.locateOnScreen("figures/generaltraining/friendship_max.png", region=rg1, confidence=confi)
                    supportcard.friendship = 1
...
if __name__ == "__main__":
    ...
    URA._start_game(Maruzensky, 0)
    URA.train_horse_loop(Maruzensky, turn=3)
    #nprint(URA.__friendship_bonus_score__("speed", list(Maruzensky.supportcard)))
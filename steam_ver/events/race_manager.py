...
from core.constants import (
    ImagePath, WaitTime, SkillUpgrade, ImageConfidence
)
    ...
    def upgrade_skills(
        ...
        while desired_skills:
            ...
            try:
                ...
                # Scroll down
                pyautogui.click(
                    x=window_bounds.x + 493,
                    y=window_bounds.y + 398
                )
    ...
    def find_race(
        ...
        while True:
            ...
            if not coord:
                ...
                pyautogui.moveTo(
                    bottom_x + window_bounds.x,
                    bottom_y + window_bounds.y
                )
                pyautogui.dragTo(
                    top_x + window_bounds.x,
                    window_bounds.y + top_y,
                    1
                )
                time.sleep(WaitTime.MEDIUM)
            else:
                # Click on found race
                ClickHandler.click_absolute(int(coord[0]), int(coord[1]))
                break
